...
//  bandit->lr = lr;
//  bandit->k = k;
//  bandit->qEstimation = ai_m_calloc(bandit->qEstimation, k, sizeof(f64));
...
//  mLoopUp(i, nBandits) {
//    f64 *banditRewards = ai_m_calloc(banditRewards, runs, sizeof(f64));
//    u32 *banditBestActionCount = ai_m_calloc(banditBestActionCount, runs, sizeof(u32));
//
//    mLoopUp(r, runs) {
